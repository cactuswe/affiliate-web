  ...
  return (
    <article>
      ...
      <div style={{ border: '1px solid #eee', borderRadius: 8, overflow: 'hidden', marginBottom: 16 }}>
        <img src={prod.image || '/placeholder.jpg'} alt={prod.title} style={{ width: '100%', height: 'auto' }} />
      </div>
      <p style={{ lineHeight: 1.6 }}>{prod.description}</p>
      <a href={url} rel="nofollow noopener" target="_blank" style={{
        display: 'inline-block', marginTop: 16, padding: '12px 16px',
        borderRadius: 6, border: '1px solid #111', textDecoration: 'none', fontWeight: 700
      }}>
        Visa på Amazon →
      </a>
