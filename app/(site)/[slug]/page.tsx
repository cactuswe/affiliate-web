...
const styles = {
  ...
  imgWrap: { position: 'relative' as const, width: '100%', maxHeight: 520, overflow: 'hidden', borderRadius: 16, background: 'linear-gradient(180deg,#fff,#f7f5f3)' , display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(0,0,0,0.04)' },
  img: { width: '100%', height: 'auto', maxHeight: 480, objectFit: 'contain' as const, display: 'block', background: 'transparent' },
